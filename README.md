...
## v2.2 URL handling fix
The dashboard defaults to the current Render origin and normalizes the Reporting API URL using `URL.origin`. Any username/password embedded in a pasted URL is discarded before fetch, preventing the browser error "URL is not valid or contains user credentials."
